<div class="col-lg-7 p-0">
    ...
    <form method="POST" action="" enctype="multipart/form-data">
        ...
        if (isset($_POST['update_post'])) {
            ...
            if (empty($post_category_id) || empty($post_title) || empty($post_author) || empty($post_content) || empty($post_tags) || empty($post_status)) {
        ...
        <div class="form-group mb-3">
            ...
            <input type="text" class="form-control" id="author" name="post_author" value="<?php echo $post_author;?>">
        </div>
